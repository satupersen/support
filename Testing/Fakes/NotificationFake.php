...
use Exception;
use Satupersen\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Satupersen\Contracts\Notifications\Factory as NotificationFactory;
use Satupersen\Contracts\Translation\HasLocalePreference;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
     ...
     * @param  string  $notification
     * @param  callable|null  $callback
     * @return \Satupersen\Support\Collection
     */
     ...
     *
     * @param  \Satupersen\Support\Collection|array|mixed  $notifiables
