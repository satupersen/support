...
use Satupersen\Contracts\Mail\Mailer;
use Satupersen\Contracts\Mail\MailQueue;
...
class MailFake implements Mailer, MailQueue
{
     ...
     *
     * @param  mixed  $users
     * @return \Satupersen\Mail\PendingMail
     */
     ...
     * @param  \Satupersen\Contracts\Mail\Mailable|string|array  $view
     * @param  string  $queue
     * @return mixed
     */
