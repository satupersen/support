...
use Satupersen\Support\Testing\Fakes\QueueFake;
 ...
 * @method static \Satupersen\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static string getConnectionName()
 * @method static \Satupersen\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 *
 * @see \Satupersen\Queue\QueueManager
 * @see \Satupersen\Queue\Queue
 */
class Queue extends Facade
{
     ...
     *
     * @return \Satupersen\Support\Testing\Fakes\QueueFake
     */
