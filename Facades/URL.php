 ...
 * @method static \Satupersen\Contracts\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 ...
 * @method static bool hasValidSignature(\Satupersen\Http\Request $request, bool $absolute = true)
 * @method static void defaults(array $defaults)
 * @method static void forceScheme(string $scheme)
 *
 * @see \Satupersen\Routing\UrlGenerator
 */
