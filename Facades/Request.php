 ...
 * @method static \Satupersen\Http\UploadedFile|\Satupersen\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \Satupersen\Http\Request capture()
 * @method static \Satupersen\Http\Request instance()
 ...
 * @method static \Satupersen\Http\Request merge(array $input)
 * @method static \Satupersen\Http\Request replace(array $input)
 * @method static \Symfony\Component\HttpFoundation\ParameterBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \Satupersen\Http\Request createFrom(\Satupersen\Http\Request $from, \Satupersen\Http\Request|null $to = null)
 * @method static \Satupersen\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \Satupersen\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 * @method static mixed filterFiles(mixed $files)
 * @method static \Satupersen\Session\Store session()
 * @method static \Satupersen\Session\Store|null getSession()
 * @method static void setLaravelSession(\Satupersen\Contracts\Session\Session $session)
 * @method static mixed user(string|null $guard = null)
 * @method static \Satupersen\Routing\Route|object|string route(string|null $param = null, string|null $default = null)
 * @method static string fingerprint()
 * @method static \Satupersen\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \Closure getUserResolver()
 * @method static \Satupersen\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \Satupersen\Http\Request setRouteResolver(\Closure $callback)
